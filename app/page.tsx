...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-slate-100 selection:bg-[#F08784]/20" dir="rtl">
      ...
      {/* Footer */}
      <footer className="py-16 border-t border-slate-300 bg-slate-900 text-slate-300" dir="rtl">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            {/* معلومات الشركة */}
            <div>
              <div className="mb-6">
                <Image src="/logo2.png" alt="هابي مومنتس" width={140} height={50} className="object-contain brightness-0 invert" />
              </div>
              ...
              <div className="flex items-center gap-4">
                <a
                  ...
                  className="w-12 h-12 bg-slate-800 hover:bg-gradient-to-br hover:from-[#F08784] hover:to-[#D97673] rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                  aria-label="انستجرام"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-slate-800 hover:bg-gradient-to-br hover:from-[#25D366] hover:to-[#128C7E] rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                  aria-label="واتساب"
                >
                  <svg className="w-6 h-6 text-slate-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="/" className="text-slate-400 hover:text-[#F08784] transition-colors flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 bg-slate-600 rounded-full group-hover:bg-[#F08784] transition-colors"></span>
                    الرئيسية
                  </a>
                </li>
                <li>
                  <a href="/#about" className="text-slate-400 hover:text-[#F08784] transition-colors flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 bg-slate-600 rounded-full group-hover:bg-[#F08784] transition-colors"></span>
                    نبذة عنا
                  </a>
                </li>
                <li>
                  <a href="/gallery" className="text-slate-400 hover:text-[#F08784] transition-colors flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 bg-slate-600 rounded-full group-hover:bg-[#F08784] transition-colors"></span>
                    معرض الأعمال
                  </a>
                </li>
                <li>
                  <a href="/#services" className="text-slate-400 hover:text-[#F08784] transition-colors flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 bg-slate-600 rounded-full group-hover:bg-[#F08784] transition-colors"></span>
                    خدماتنا
                  </a>
                </li>
                <li>
                  <a href="/login" className="text-slate-400 hover:text-[#F08784] transition-colors flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 bg-slate-600 rounded-full group-hover:bg-[#F08784] transition-colors"></span>
                    تسجيل الدخول
                  </a>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-slate-400">
                  <svg className="w-5 h-5 text-[#F08784] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <div>
                    <div className="text-sm text-slate-500 mb-1">اتصل بنا</div>
                    <a href="tel:+96565594787" className="hover:text-[#F08784] transition-colors font-medium">
                      +965 6559 4787
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-3 text-slate-400">
                  ...
                  <div>
                    <div className="text-sm text-slate-500 mb-1">الموقع</div>
          ...
          <div className="border-t border-slate-800 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-500">
              ...
              <div className="flex items-center gap-6">
                <a href="#" className="hover:text-[#F08784] transition-colors">سياسة الخصوصية</a>
                <a href="#" className="hover:text-[#F08784] transition-colors">الشروط والأحكام</a>
              </div>
            </div>
          </div>
        </div>
